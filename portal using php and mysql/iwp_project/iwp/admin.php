...
$headers .= 'From: diptiagarwalf3@gmail.com' . "\r\n";
...
<head>
    ...
    $(document).ready(function(){
        var i;
        var s1=" ";
        $.ajax({url:"http://localhost:8080/iwp_project/iwp_products/api/payment/read.php", success:function(result){
            //console.log(result.data[0].id);
            //console.log(result.data.length);
            for( i=0;i<result.data.length;i++){
                 s1 = s1 + (result.data[i].id)+"<br>";
